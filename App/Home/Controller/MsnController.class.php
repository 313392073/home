...
class MsnController extends Controller {
    ...
    public function __construct($cofig = array()) {
        $cofig = array (
            'accessKeyId' => 'LTAIjuXbsTQDcINI',
            'accessKeySecret' => 'cQFsCe9m57Ka2q2llu4MPLu5iGajjG',
            'signName' => '公用签名',
            'templateCode' => 'SMS_47575058'
        );
        // 配置参数
    ...
    public function send_verify($mobile) {
        ...
        $params = array (
            ...
            'RecNum' => $mobile,
            'ParamString' => '{"code":"' . $code . '","product":"大渝棋牌商务平台"}'
        );
        // 计算签名并把签名结果加入请求参数
...
//
////测试模式
//$status = $sms->send_verify("13458563587",$code);
//
//if (!$status) {
//    echo $sms->error;
//}
